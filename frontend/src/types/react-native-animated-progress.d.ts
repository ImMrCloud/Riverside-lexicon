/**
 * Created this type file because there was a type error in the latest version of react-native with the old version of @types/react-native in the @types/react-native-animated-progress package.
 */
