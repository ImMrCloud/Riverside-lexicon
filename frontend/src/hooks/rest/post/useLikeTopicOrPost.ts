...
import { TOPICS } from '../../../api/discourse-apollo-rest/topics';
...
import { useMutation, useOngoingLikedTopic } from '../../../utils';
...
// NOTE: Will fix updating the fragments later when implementing it to component
